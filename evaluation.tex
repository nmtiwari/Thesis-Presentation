\section{Evaluation}
    ...
    \subsection{Applicability}
        ...
        \begin{frame}
            ...
            \input{figures/questions}
         \end{frame}

%        \begin{frame}
%            \frametitle{Candoia apps used in evaluation}
%            \input{figures/question}
%         \end{frame}
    ...
    \subsection{Adoptability}
        ...
        \begin{frame}
            ...
            \input{figures/project-settings}
         \end{frame}

        \begin{frame}
            \frametitle{LOC changes in Boa v/s. Java}
            \input{figures/adoptability}
         \end{frame}

        \begin{frame}
            \frametitle{LOC changes in Boa v/s. Java}
            \input{figures/adoptability1}
         \end{frame}
 ...
 \subsection{Customizability}
        ...
        \begin{frame}
%            \frametitle{LOC changes in Boa v/s. Java}
            \input{figures/customizability}
         \end{frame}

        \begin{frame}
%            \frametitle{LOC changes in Boa v/s. Java}
            \input{figures/customizability1}
         \end{frame}